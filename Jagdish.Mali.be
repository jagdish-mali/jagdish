        ...
        <div class="container-wrap">
            ...
            <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
                <div class="text-center">
                    ...
                    <h1 id="colorlib-logo"><a href="index.html">Jagdish Mali</a></h1>
                    <span class="position"><a href="#">Designer Student</a> in Belgium</span>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                                            <div class="slider-text-inner js-fullheight">
                                                <div class="desc">
                                                    <h1>Hi! <br>I'm Jagdish</h1>
                                                    <h2><a href="https://colorlib.com/" target="_blank"></a></h2>
                                                    <p><a class="btn btn-primary btn-learn"><i class="icon-download4"></i></a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                    <div class="col-md-12">
                                        <div class="about-desc">
                                            ...
                                            <p><strong>Hi I'm Jagdish Mali</strong>  I'm 18 and a student of Design, Publiciteit en Illustratie.​I love to create in any kind of ways and I believe that if people create together, things become even greater. It's all about being and becoming inspired by underestimated things.​</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
